...
//Glued Doubled Linked list as a glued library


//Definition of a node, it does not have information about application info
//as a regular double linked list has.
